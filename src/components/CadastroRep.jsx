    ...
    return (
        <form action="" className={styles.form} >
            ...
            <fieldset className={styles.inputBox}>
                <div className={styles.flex}>
                    ...
                    <div className={styles.flex3}>
                        <label htmlFor="useName">Nome Uso <span>*</span></label>
                        <input type="text" id="useName" name="useName" />
                    </div>
                    <div className={styles.flex1}>
                        <label htmlFor="namePir">Nome Pir <span>*</span></label>
            ...
            <fieldset className={styles.inputBox}>
                <div className={styles.flex}>
                    <div className={styles.flex2}>
                        <label htmlFor="useName">Tipo Comissão <span>*</span></label>
                        <div className={styles.customSelect}>
                            <select type="text" id="useName" name="useName">
                                <option value="faturamento">Faturamento1</option>
                                <option value="faturamento">Faturamento2</option>
                                <option value="faturamento">Faturamento3</option>
                            </select>
                        </div>
                    </div>
                    <div className={styles.flex1}>
            ...
            <fieldset className={styles.inputBox}>
                <div className={styles.flex}>
                    <div className={styles.flex1}>
                        <label htmlFor="tipoRepr">Tipo Representante <span>*</span></label>
                        <input type="text" id="tipoRepr" name="tipoRepr" />
                    </div>
                    <div className={styles.flex1}>
                        <label htmlFor="irff">IRFF <span>*</span></label>
            ...
            <fieldset className={styles.inputBox}>
                <div className={styles.flex}>
                    <div className={styles.flex1}>
                        <label htmlFor="inicioVendas">Início Vendas <span>*</span></label>
                        <input type="date" id="inicioVendas" name="inicioVendas" />
                    </div>
                    <div className={styles.flex1}>
                        <label htmlFor="tipoMercado">Tipo de Mercado <span>*</span></label>
            ...
            <fieldset className={styles.inputBox}>
                <div className={styles.flex}>
                    <div className={styles.flex1}>
                        <label htmlFor="representandeLider">Representante Líder <span>*</span> </label>
                        <input type="text" id="representandeLider" name="representandeLider" />
                    </div>
                    <div className={styles.flex1}>
                        <label htmlFor="regiaoVenda">Região Venda <span>*</span></label>
                        <input type="text" id="regiaoVenda" name="regiaoVenda" />
                    </div>
                    <div className={styles.flex1}>
                        <label htmlFor="regiaoCota">Região Cota <span>*</span></label>
