    ...
    <form action="" className={styles.form}>
      ...
      <fieldset className={styles.inputBox}>
        <div className={styles.flex}>
          ...
          <div className={styles.flex2}>
            ...
            <InputMask mask="99999-999" id="cep" name="cep" placeholder="00000-000" maskChar="">
      ...
      <fieldset className={styles.inputBox}>
        <div className={styles.flex}>
          ...
          <div className={styles.flex3}>
            ...
            <InputMask mask="999(99)9999-9999" id="fax" name="fax" placeholder="DDD/(00)0000-0000" maskChar="">
              {(inputProps) => <input {...inputProps} className="input-field" />}
            </InputMask>
          </div>
        </div>
      ...
      <fieldset className={styles.inputBox}>
        <div className={styles.flex}>
          <div className={styles.flex3}>
            ...
            <InputMask mask="99.999.999/9999-99" id="cnpj" name="cnpj" placeholder="00.000.000/0000-00" maskChar="">
              {(inputProps) => <input {...inputProps} className="input-field" />}
            </InputMask>
          </div>
          <div className={styles.flex3}>
      ...
      <fieldset className={styles.inputBox}>
        <div className={styles.flex}>
          ...
          <div className={styles.flex3}>
            <label htmlFor="namePir">
              Empresa Líder<span>*</span>
            </label>
            <input type="number" id="useName" name="useName" />
          </div>
          <div className={`${styles.flex3} ${styles.inputLider}  `}>
            <label htmlFor="namePir">
              Líder do Grupo<span>*</span>
            </label>
